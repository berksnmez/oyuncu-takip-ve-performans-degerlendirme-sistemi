...
interface ForvetGolculukChartProps {
...
export default function ForvetGolculukChart({ 
  forvetData, 
  currentPlayerId, 
  isExpanded, 
  onToggleExpand 
}: ForvetGolculukChartProps) {
  ...
  const referenceLinePlugin = {
    ...
    afterDatasetsDraw(chart: any) {
      ...
      const yPos = scales.y.getPixelForValue(0.35);
      ...
      const xPos = scales.x.getPixelForValue(0.25);
  ...
  return (
    <div className={`bg-white border rounded-lg shadow-sm transition-all duration-300 overflow-hidden ${
      ...
      <div className="p-2 border-b flex justify-between items-center">
        <h3 className="text-sm font-medium truncate">Golcülük</h3>
        {onToggleExpand && (
          <button 
      ...
      {isExpanded ? (
        <div className="flex flex-col md:flex-row">
          <div className="md:w-1/4 p-2">
            ...
            <p className="text-xs mb-2">Gol sayıları ve gol beklentisinin üzerine çıkma oranları.</p>
            <p className="text-xs">Golcülük yeteneği ve bitiricilik özelliklerinin karşılaştırması.</p>
          </div>
            ...
            <div className="h-[500px] relative">
              ...
              <>
                ...
                <div className="absolute ml-12 mt-3 text-left z-10">
                  <div className="font-bold text-xs" style={{ color: 'rgba(255, 140, 0, 1)' }}>Gol Yüksek</div>
                ...
                <div className="absolute right-0 mr-3 mt-3 text-right z-10">
                  <div className="font-bold text-xs" style={{ color: 'rgba(0, 128, 0, 1)' }}>Gol Yüksek</div>
                ...
                <div className="absolute bottom-0 ml-12 mb-12 text-left z-10">
                  <div className="font-bold text-xs" style={{ color: 'rgba(255, 0, 0, 1)' }}>Gol Düşük</div>
                ...
                <div className="absolute bottom-0 right-0 mr-3 mb-12 text-right z-10">
                  <div className="font-bold text-xs" style={{ color: 'rgba(255, 140, 0, 1)' }}>Gol Düşük</div>
