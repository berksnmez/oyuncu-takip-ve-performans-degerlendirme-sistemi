...
interface ForvetAtilanGolChartProps {
...
export default function ForvetAtilanGolChart({ 
  forvetData, 
  currentPlayerId, 
  isExpanded, 
  onToggleExpand 
}: ForvetAtilanGolChartProps) {
  ...
  return (
    <div className={`bg-white border rounded-lg shadow-sm transition-all duration-300 overflow-hidden ${
      ...
      <div className="p-2 border-b flex justify-between items-center">
        <h3 className="text-sm font-medium truncate">Atılan Gol</h3>
        {onToggleExpand && (
          <button 
      ...
      {isExpanded ? (
        <div className="flex flex-col md:flex-row">
          <div className="md:w-1/4 p-2">
            <h4 className="font-semibold text-sm mb-2">Forvet Atılan Gol Analizi</h4>
            <p className="text-xs mb-2">Gol beklentisinin üzerine çıkma ve asist beklentisi değerleri.</p>
            <p className="text-xs">Golcülük performansı ve asist potansiyelinin karşılaştırması.</p>
          </div>
