...
interface ForvetGenelHucumBeklentisiChartProps {
...
export default function ForvetGenelHucumBeklentisiChart({ 
  forvetData, 
  currentPlayerId, 
  isExpanded, 
  onToggleExpand 
}: ForvetGenelHucumBeklentisiChartProps) {
  const chartRef = useRef<ChartJS<'scatter'>>(null);

  const chartData = {
    datasets: [
      {
        label: 'Forvet Genel Hücum Beklentisi İstatistikleri',
        data: forvetData
          .filter(forvet => {
  ...
  const referenceLinePlugin = {
    ...
    afterDatasetsDraw(chart: any) {
      ...
      const yPos = scales.y.getPixelForValue(0.25);
  ...
  return (
    <div className={`bg-white border rounded-lg shadow-sm transition-all duration-300 overflow-hidden ${
      ...
      <div className="p-2 border-b flex justify-between items-center">
        <h3 className="text-sm font-medium truncate">Genel Hücum Beklentisi</h3>
        {onToggleExpand && (
          <button 
      ...
      {isExpanded ? (
        <div className="flex flex-col md:flex-row">
          <div className="md:w-1/4 p-2">
            ...
            <p className="text-xs mb-2">Gol beklentisine göre performans ve asist beklentisi değerleri.</p>
            <p className="text-xs">Hem gol atma hem de asist yapma potansiyelinin karşılaştırması.</p>
          </div>
            ...
            <div className="h-[500px] relative">
              ...
              <>
                ...
                <div className="absolute ml-12 mt-3 text-left z-10">
                  <div className="font-bold text-xs" style={{ color: 'rgba(255, 140, 0, 1)' }}>PH-xG Yüksek</div>
                ...
                <div className="absolute right-0 mr-3 mt-3 text-right z-10">
                  <div className="font-bold text-xs" style={{ color: 'rgba(0, 128, 0, 1)' }}>PH-xG Yüksek</div>
                ...
                <div className="absolute bottom-0 ml-12 mb-12 text-left z-10">
                  <div className="font-bold text-xs" style={{ color: 'rgba(255, 0, 0, 1)' }}>PH-xG Düşük</div>
                ...
                <div className="absolute bottom-0 right-0 mr-3 mb-12 text-right z-10">
                  <div className="font-bold text-xs" style={{ color: 'rgba(255, 140, 0, 1)' }}>PH-xG Düşük</div>
